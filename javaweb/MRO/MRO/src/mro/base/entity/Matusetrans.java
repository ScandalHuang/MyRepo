...
public class Matusetrans implements java.io.Serializable {
	...
	public Matusetrans(BigDecimal matusetransid, Date transdate,
			Date actualdate, BigDecimal quantity, BigDecimal curbal,
			BigDecimal physcnt, BigDecimal unitcost, BigDecimal actualcost,
			String enterby, BigDecimal outside, BigDecimal rollup,
			String issuetype, BigDecimal linecost, String currencycode,
			BigDecimal sparepartadded, String orgid, String siteid,
	...
	public Matusetrans(BigDecimal matusetransid, String itemnum,
			String storeloc, Date transdate, Date actualdate,
			BigDecimal quantity, BigDecimal curbal, BigDecimal physcnt,
			BigDecimal unitcost, BigDecimal actualcost, String ponum,
			BigDecimal conversion, String assetnum, String enterby, String it1,
			String it2, String it3, BigDecimal it4, String it5, String memo,
			BigDecimal outside, String issueto, String packingslipnum,
			BigDecimal polinenum, BigDecimal rollup, String itin1,
			String itin2, String itin3, String binnum, String lotnum,
			String issuetype, String gldebitacct, String glcreditacct,
			BigDecimal linecost, String financialperiod, String currencycode,
			BigDecimal currencyunitcost, String rotassetnum,
			BigDecimal currencylinecost, String location, String description,
			BigDecimal exchangerate, BigDecimal sparepartadded,
			BigDecimal qtyrequested, BigDecimal exchangerate2,
			BigDecimal linecost2, String mrnum, BigDecimal mrlinenum,
			BigDecimal matrectransid, String it6, String it7, String it8,
			String it9, String it10, String itin4, String itin5, String itin6,
			String itin7, String sourcesysid, String ownersysid,
			String externalrefid, String sendersysid, String fincntrlid,
			BigDecimal issueid, BigDecimal qtyreturned, String orgid,
			String siteid, String refwo, BigDecimal enteredastask,
			String linetype, String itemsetid, String conditioncode,
			BigDecimal condrate, String commoditygroup, String commodity,
			String tositeid, String langcode, BigDecimal hasld, String rowstamp,
			String transType) {
		this.matusetransid = matusetransid;
	...
	@Column(name = "ISSUETYPE", nullable = false, length = 25)
