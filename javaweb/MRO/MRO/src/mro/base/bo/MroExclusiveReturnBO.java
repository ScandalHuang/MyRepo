...
@Component
public class MroExclusiveReturnBO {
	...
	public List getListByPlantCode(LocationSiteMap locationSiteMap,String organizationCode) {
		List criterions = new ArrayList();
		criterions.add(RestrictionsUtils.eq("organizationCode",
				organizationCode));
		criterions.add(RestrictionsUtils.eq("locationSiteMap",locationSiteMap));
		return commonDAO.query(
				MroExclusiveReturn.class,
				Arrays.asList(Order.asc("organizationCode"),
						Order.asc("itemnum")), criterions);
	}
	@Transactional(readOnly = true)
	public List getListByclassstructureid(LocationSiteMap locationSiteMap,String classstructureid) {
		List criterions = new ArrayList();
		criterions.add(Restrictions.isNull("itemnum"));
	...
	public void delete(List<MroExclusiveReturn> list) {
