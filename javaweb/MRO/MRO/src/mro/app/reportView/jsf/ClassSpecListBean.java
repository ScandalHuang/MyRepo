...
import mro.app.reportView.bo.ClassSpectListBo;
...
@ManagedBean(name = "ClassSpecListBean")
@ViewScoped
public class ClassSpecListBean {
	private transient ClassSpectListBo bo;
	...
	public ClassSpecListBean() {

	}

	@PostConstruct
	public void init() {
		bo = SpringContextUtil.getBean(ClassSpectListBo.class);
