...
import mro.app.reportView.bo.R2InventoryListBo;
import mro.utility.vo.ColumnModel;

import com.inx.commons.util.SpringContextUtil;
import com.inx.commons.util.Utility;

@ManagedBean(name = "R2InventoryListBean")
@ViewScoped
public class R2InventoryListBean{
	private transient R2InventoryListBo bo;
	...
	public R2InventoryListBean() {
		
	}

	@PostConstruct
	public void init() {
		bo=SpringContextUtil.getBean(R2InventoryListBo.class);
	}
