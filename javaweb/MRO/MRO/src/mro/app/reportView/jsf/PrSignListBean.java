...
import mro.app.reportView.bo.PrSignListBo;
import mro.utility.vo.ColumnModel;

import com.inx.commons.util.SpringContextUtil;
import com.inx.commons.util.Utility;

@ManagedBean(name = "PrSignListBean")
@ViewScoped
public class PrSignListBean {
	private transient PrSignListBo bo;
	...
	public PrSignListBean() {

	}

	@PostConstruct
	public void init() {
		bo = SpringContextUtil.getBean(PrSignListBo.class);
