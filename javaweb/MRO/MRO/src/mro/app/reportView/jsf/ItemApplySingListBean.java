...
import mro.app.reportView.bo.ItemApplySingListBo;
import mro.utility.vo.ColumnModel;

import com.inx.commons.util.SpringContextUtil;
import com.inx.commons.util.Utility;

@ManagedBean(name = "ItemApplySingListBean")
@ViewScoped
public class ItemApplySingListBean {
	private transient ItemApplySingListBo bo;
	...
	public ItemApplySingListBean() {

	}

	@PostConstruct
	public void init() {
		bo = SpringContextUtil.getBean(ItemApplySingListBo.class);
