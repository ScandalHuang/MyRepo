...
import mro.app.reportView.dao.ItemChangeSignListDao;
...
@Component
@Scope("prototype")
public class ItemChangeSignListBo {

	private ItemChangeSignListDao dao;

	@Autowired
	@Qualifier(value = "DEFAULT_SESSION_FACTORY")
	public void initDAO(SessionFactory sessionFactory) {
		dao = new ItemChangeSignListDao(sessionFactory);
	}
