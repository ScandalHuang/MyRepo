...
import mro.app.overview.bo.ZMroNonOpenPoListBo;
...
@ManagedBean(name = "ZMroNonOpenPoListBean")
@ViewScoped
public class ZMroNonOpenPoListBean {
	private transient ZMroNonOpenPoListBo bo;
	...
	public ZMroNonOpenPoListBean() {

	}

	@PostConstruct
	public void init() {
		bo = SpringContextUtil.getBean(ZMroNonOpenPoListBo.class);
	...
	public void search() {
		...
		list = bo.getList(locationSite,organizationCode,  itemtype, itemnum,
				 prnum, ponum, description, subinventory);
