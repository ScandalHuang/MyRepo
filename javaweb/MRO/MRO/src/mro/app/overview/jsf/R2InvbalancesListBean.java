...
import mro.app.overview.bo.R2InvbalancesListBo;
import mro.utility.vo.ColumnModel;

import com.inx.commons.util.SpringContextUtil;
import com.inx.commons.util.Utility;

@ManagedBean(name = "R2InvbalancesListBean")
@ViewScoped
public class R2InvbalancesListBean{
	private transient R2InvbalancesListBo bo;
	...
	public R2InvbalancesListBean() {
		
	}

	@PostConstruct
	public void init() {
		bo=SpringContextUtil.getBean(R2InvbalancesListBo.class);
	}
