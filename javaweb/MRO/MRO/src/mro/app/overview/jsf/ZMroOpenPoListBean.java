...
import mro.app.overview.bo.ZMroOpenPoListBo;
...
@ManagedBean(name = "ZMroOpenPoListBean")
@ViewScoped
public class ZMroOpenPoListBean {
	private transient ZMroOpenPoListBo bo;
	...
	public ZMroOpenPoListBean() {

	}

	@PostConstruct
	public void init() {
		bo = SpringContextUtil.getBean(ZMroOpenPoListBo.class);
