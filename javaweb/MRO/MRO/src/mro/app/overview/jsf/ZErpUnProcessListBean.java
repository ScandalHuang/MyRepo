...
import mro.app.overview.bo.ZErpUnProcessListBo;
...
@ManagedBean(name = "ZErpUnProcessListBean")
@ViewScoped
public class ZErpUnProcessListBean {
	private transient ZErpUnProcessListBo bo;
	...
	public ZErpUnProcessListBean() {

	}

	@PostConstruct
	public void init() {
		bo = SpringContextUtil.getBean(ZErpUnProcessListBo.class);
