...
import mro.app.overview.dao.ZMroNonOpenPoListDao;
...
@Component
@Scope("prototype")
public class ZMroNonOpenPoListBo {

	private ZMroNonOpenPoListDao dao;

	@Autowired
	@Qualifier(value = "DEFAULT_SESSION_FACTORY")
	public void initDAO(SessionFactory sessionFactory) {
		dao = new ZMroNonOpenPoListDao(sessionFactory);
	}

	@Transactional(readOnly = true)
	public List getList(String locationSite,String[] organizationCode, String itemtype,String itemnum,
			String prnum,String ponum,String description,String subinventory) {
		...
		if (StringUtils.isNotBlank(ponum)) {
			condition.append("AND PO_NO like :ponum ");
			param.put("ponum", ponum+"%");
		}
